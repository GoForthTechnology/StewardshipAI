...
- Name: verify-styles.spec.ts >> Stewardship Portal Branding >> should apply diocese-cream background to main content
- Location: verify-styles.spec.ts:28:7
